# Enhanced Single Function for scRNA-seq Ensemble Clustering with Quality Indices
ensemble_clustering_algorithms <- function(expression_data, true_labels = NULL, H_matrix = H, k = NULL,
